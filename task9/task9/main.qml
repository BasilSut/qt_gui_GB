...
RowLayout{
   ...
   Button{
       id: button2
       text: qsTr("Add DeadLine")
       //text: Qt.formatDate(tempDate, "dd.MM.yyyy");



       onClicked: dialogCalendar2.show(tempDate)
       //onClicked:     dialogCalendar1.open()
   }
                ...
                Button {
                    ...
                    onClicked: {
                        ...
                        //button.text = Qt.formatDate(tempDate, "dd.MM.yyyy");
                            ...
                            textEdit.append(Qt.formatDate(tempDate, "\ndd.MM.yyyy"));
...
Dialog {
    ...
    contentItem: Rectangle {
            ...
            style: CalendarStyle {
                ...
                navigationBar: Rectangle {
                    ...
                    Button {
                         ...
                         * календаря, которая отматывает месяц назад
                         * */
                        onClicked: control2.showNextMonth()
        ...
        Row {
            ...
            Button {
                ...
                // По нажатию на кнопку - просто закрываем диалог
                onClicked: dialogCalendar2.close()
            }
            ...
            Button {
                ...
                onClicked: {
                    ...
                    //button.text = Qt.formatDate(tempDate, "dd.MM.yyyy");
                       ...
                       textEdit.append(Qt.formatDate(tempDate, " dd.MM.yyyy - Dea'd'line! \n"));

                    dialogCalendar2.close();
                }
            }
        }
    }
    ...
    function show(x){
        //calendar2.selectedDate = x
        dialogCalendar2.open()
    }
}
}
